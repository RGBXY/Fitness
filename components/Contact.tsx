    ...
    <div className="h-full pb-10">
      ...
      <div className="bg-[#1391AD40] flex flex-col pb-14 h-full lg:px-20 px-5">
        <div className="w-full h-[350px] rounded-3xl overflow-hidden -mt-64 relative">
          <Image className="w-full h-full object-cover" height={1600} width={900} src={"/assets/contact.jpeg"} alt="contact" />
        ...
        <div className="parent flex justify-between gap-10 flex-col lg:flex-row mt-16">
          ...
          <div className="child-2 lg:w-[33%] rounded-2xl bg-white text-black py-8 px-8">
            ...
            <div className="flex gap-5 items-start my-6">
              <Image className="h-8 w-8" height={30} width={30} src={"/assets/email.svg"} alt="contact" />
              <div>
            ...
            <div className="flex gap-5 items-start my-6">
              <Image className="mt-1" height={30} width={30} src={"/assets/phone.svg"} alt="contact" />
              <div>
            ...
            <div className="flex gap-5 items-start my-6">
              <Image className="mt-1" height={30} width={30} src={"/assets/Location.svg"} alt="contact" />
              <div>
