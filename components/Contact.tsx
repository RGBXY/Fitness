  ...
  return (
    <div id="about" className="h-full pb-10">
      ...
      <div className="bg-[#1391AD40] flex flex-col pb-14 h-full lg:px-20 px-5">
        ...
        <div className="parent flex justify-between gap-10 flex-col lg:flex-row mt-10 lg:mt-16">
          ...
          <div className="child-2 lg:w-[33%] rounded-2xl bg-white text-black py-8 px-5 lg:px-8">
            ...
            <div className="flex gap-5 items-start my-6">
              ...
              <div>
                ...
                <p className="text-[0.8rem] text-wrap">ecotourtravelkarimunjawa@gmail.com</p>
              </div>
            </div>
            <div className="flex gap-5 items-start my-6">
